...
import Updatecategery from "../Categery/Updatecategery";
// import Viewrole from "../User/Viewrole";
...
//  const[postPerPage, setPostPerPage] = useState(4)
  ...
  function getList() {
    async function getData() {
      const response = await fetch("http://localhost:5555/api/viewuser");
  ...
  return (
    <>
      <h3 style={{ backgroundColor: "pink", textAlign: "center" }}>Users</h3>
      <Button
        variant="info"
